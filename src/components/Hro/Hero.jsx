...
const Hero = () => {
   return (
      <div className=' w-full h-[100vh] relative mt-10 md:overflow-y-hidden md:flex md:justify-between md:gap-10 pb-20 '>
         <div className='w-full flex flex-col justify-center md:justify-between md:py-3'>
            ...
            <p className='leading-normal text-gray-600 max-w-md md:text-2xl'> Nikmati kelezatan ayam bakar dengan bumbu spesial yang menggugah selera </p>
